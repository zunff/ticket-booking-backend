...
public enum PayMode {
    ...
    // 微信 / 支付宝共有
    WECHAT_ALIPAY_APP("app", "微信/支付宝APP支付"),

    // 支付宝独有
    ALIPAY_WEB("web", "支付宝PC网站支付"),
    ALIPAY_WAP("wap", "支付宝手机网站支付"),

    // 模拟渠道独有
    MOCK_PAGE_CONFIRM("page_confirm", "模拟-收银台页面确认"),
    MOCK_QUICK_SUCCESS("quick_success", "模拟-快速成功"),
    MOCK_QUICK_FAIL("quick_fail", "模拟-快速失败");
