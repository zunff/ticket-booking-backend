...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public PaymentRecordVO getDetail(String outTradeNo) {
    ...
    @Override
    public PageResult<PaymentRecordVO> getPage(Long current, Long size, String outTradeNo, PayChannel channel, Integer status) {
